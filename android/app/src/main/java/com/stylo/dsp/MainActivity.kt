...
class MainActivity : Activity() {
    ...
    private inner class EqView:View(this){
        private val p=Paint(Paint.ANTI_ALIAS_FLAG);private val path=Path();private val spectrum=FloatArray(1024);private var drag=false;private var pinch=false;private var pinchStart=0f;private var qStart=1f
